                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="Lorem,Ipsum,Amet" data-role="tagsinput" name="product_tags_en" class="form-control" value="{{$products->product_tags_en}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="Lorem,Ipsum,Amet" data-role="tagsinput" name="product_tags_hin" class="form-control" value="{{$products->product_tags_hin}}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_size_en" class="form-control" required="" value="Small, Medium, Large" data-role="tagsinput" value="{{$products->product_size_en}}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_size_hin" class="form-control" required="" value="Small, Medium, Large" data-role="tagsinput" value="{{$products->product_size_hin}}">
